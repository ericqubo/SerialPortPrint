...
namespace Test
{
    ...
    public class DeviceManager : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            SetContentView(Test.Resource.Layout.BluetoothSetting);
            var scanButton = FindViewById<Button>(Test.Resource.Id.btnScan);
            ...
            var newDevicesListView = FindViewById<ListView>(Test.Resource.Id.listView1);
            newDevicesListView.Adapter = newDevicesArrayAdapter;
            newDevicesListView.ItemClick += newDevicesListView_ItemClick;
            
            

            var pairedDevicesListView = FindViewById<ListView>(Test.Resource.Id.listView2);
